...
def main():
    ...
    with st.expander('Multiple'):
        ...
        multiple = st.number_input('Multiple',min_value=1,value=10)
        st.write(f'Mult= {[int(nn*i) for i in range(1,multiple+1)]}')
        st.write(f'Power= {[int(nn**i for i in range(1,power+1)]}')
